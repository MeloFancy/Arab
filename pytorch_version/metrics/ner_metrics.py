...
class SeqEntityScore(object):
    ...
    def result(self):
        class_info = {}
        # origin_counter = Counter([x[0] + '-' + x[1] for x in self.origins])
    ...
    def update(self, label_paths, pred_paths, cate):
        ...
        for label_path, pre_path in zip(label_paths, pred_paths):
            ...
            label_entities = [[cate, cls, beg, end] for cls, beg, end in label_entities]
            pre_entities = [[cate, cls, beg, end] for cls, beg, end in pre_entities]
